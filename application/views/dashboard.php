...
<body>
	<div class="d-flex" id="wrapper">
		<nav class="bg-light border-right" id="sidebar-wrapper">
			<div class="sidebar-heading"> Mahasiswa Ngabsen (MaNgab) </div>
		...
		<div id="page-content-wrapper">
			<nav class="navbar navbar-expand-lg border-bottom"  style="background:#03396c">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
						<li class="nav-item" style="color: white"> <?php echo $page_title ?> <br></li>
					</ul>
					<ul class="navbar-nav ml-auto mt-2 mt-lg-0">
